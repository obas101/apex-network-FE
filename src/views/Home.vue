  ...
  >
    ...
    <div class="flex flex-col mb-32 space-y-12 md:w-1/2 p-10">
      ...
      <p class="text-center md:text-left">
        ...
        majority have suffered all injected humour or randomised words which
    ...
    <div class="md:w-1/2 p-10">
      <img class="md:min-w-full" src="../assets/Group330.svg" alt="" />
    </div>
  </div>

  <!-- Testimonial -->
  <div class="bg-primaryColor">
    <div class="container text-center mx-auto mt-12 p-5">
      ...
      >
        <!-- First Card -->
        <div class="flex flex-col md:w-1/2 p-6">
